...
public class LoginUser extends HttpServlet {
    ...
    protected void doGet(final HttpServletRequest request,
        ...
        entM.clear();
        Query query;
        query = entM.createQuery("SELECT en FROM EntiteSociale en WHERE en.email LIKE ?1");
        query.setParameter(1, email);

        Query query2;
        query2 = entM.createQuery("SELECT ins FROM Inscription ins WHERE ins.entite =?1");
