...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="showMenu();">
        <div class="wrap background">
            ...
            <table style="padding: 6px; width: 100%; text-align: center; border: 0;">
                <tr>
                    <td style="width: 100%">
                        <strong>${monHub.nomCommunaute }</strong>
                        <span>${monTopic.sujet } </span>
                    </td>
                </tr>
            </table>
            <div id="community_menu"
                ...
                <table style="padding: 4px; border: 0;">
                    ...
                    <tr>
                        <td>
                            <a href="http://www.developpez.net/forums/group.php">Groupes sociaux</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a href="http://www.developpez.net/forums/album.php">Images &amp; albums</a>
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <tr>
                        <td class="vbmenu_option" title="nohilite">
                            <form id="pagenav_form" method="get" action="">
                                <p>
                                    <input class="bginput" id="pagenav_itxt" style="FONT-SIZE: 11px; size: 4;" />
                                </p>
                                <p>
                                    <input class="button" id="pagenav_ibtn" type="button" value="Go" />
                                </p>
                            </form>
                        </td>
                    </tr>
            ...
            <table style="MaRGIN-BOTTOM: 3px; width: 100%; cellPadding: 0; border: 0">
                <tr valign="bottom">
            ...
            <div style="align: center">
                <div class="page" style="width: 100%; text-align: left">
                    <div
                        ...
                        <div id="edit3994424" style="PaDDING-RIGHT: 0px; PaDDING-LEFT: 0px; PaDDING-BOTTOM: 6px; PaDDING-TOP: 0px">
                            ...
                            <table class="tborder" id="post3994424" width="100%">
                                <tr>
                                    <td colspan="2" class="thead" style="background-color: #CCCCCC">
                                        ${monTopic.sujet}
                                    </td>
                                </tr>
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td class="" id="td_post_3994424"
                                            ...
                                            <c:if test="${messageDTO.message.propMsg.id == entite.id}">
                                                <a href="SupprMess?idMess=${messageDTO.message.id}&idEntite=${entite.id}">
                                                    <img src="images/croix.jpg" width="15"/>
                                                </a>
                                                <a href="GotoModifMessage?idMess=${messageDTO.message.id}">
