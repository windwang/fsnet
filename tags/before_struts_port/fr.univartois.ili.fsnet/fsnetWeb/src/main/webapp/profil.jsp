...
<html>
    <head>
        ...
        <script type="text/javascript">
             ...
             */
            var CL = new GnooCalendar("CL", 40, 10,"Profil");
                ...
                <div id="left">
                    ...
                    <form name="testform" action="CompleteProfil" method="post"
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="height: 27px" colspan="3" rowspan="5">
                                    <strong>Nom :</strong>
                                </td>
                                <td colspan="2"></td>
                            </tr>
                            ...
                            <tr>
                                <td style="height: 21px" colspan="3">
                                    <strong>Date d'entr&eacute;e : </strong>
                                </td>
                                <td colspan="2">
                                    <label>
                                        <input type="text" name="dateEntree" disabled="disabled" value="${membre.dateEntree}" />
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 29" colspan="3">
                                    <strong>Date de naissance :</strong>
                                </td>
                                <td colspan="2">
                                    <label>
                                        <input type="text" name="dateNaissance" value="${membre.dateNaissance }" />
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    Homme : <INPUT type="radio" name="sexe" ${checkM} value="M">
                                    Femme : <INPUT type="radio" name="sexe" ${checkF} value="F">
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 29px" colspan="3">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <label>
                                        <input type="text" name="telephone" value="${membre.numTel }" />
                                    </label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <label>
                                        <input type="password" name="pwd1" value="${membre.mdp}" />
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <label>
                                        <input type="password" name="pwd2" value="${membre.mdp}"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <fsnet:interet var="interet" idLogin="${entite.id}">
                                <tr>
                                    <td>
                                        <input type="checkbox" name="interestSelected" value="${interet.id}" title="Sélectionner" ${check }/>
                                    </td>
