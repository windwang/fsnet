...
@XmlRootElement(name = "isMember", namespace = "http://webservice.fsnet.ili.univartois.fr/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "isMember", namespace = "http://webservice.fsnet.ili.univartois.fr/", propOrder = {
    "login",
    "password"
})
