...
ProfileVisitePKTest.class, CurriculumTest.class,CommunityTest.class, ConsultationChoiceTest.class, HubTest.class,
		...
		,InteractionGroupsTest.class, SocialElementTest.class, HobbiesCVTest.class, PropertyTest.class, FormationCvTest.class, EstablishmentCvTest.class, MessageTest.class})
