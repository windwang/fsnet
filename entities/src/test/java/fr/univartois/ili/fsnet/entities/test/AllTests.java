...
ProfileVisitePKTest.class, CurriculumTest.class,CommunityTest.class, ConsultationChoiceTest.class, HubTest.class,
		...
		SocialEntityTest.class,DegreeCvTest.class,MessageTest.class, SocialGroupTest.class,InteractionRolePKTest.class, TopicTest.class, PrivateMessageTest.class , AssociationDateDegreeCVTest.class
