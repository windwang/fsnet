...
<div class='support-content'>
	<h3 class='support-title'>
		<bean:message key="support.title.title" />
	</h3>
	<br />
	...
	<html:form action="/ContacterSupport">
		<table id="ContacterSupport">
			<tr>
				<td><label for="supportTitle"> <bean:message
							key="support.title.subject" /> :
				</label></td>
				<td><html:text property="supportTitle" styleId="supportTitle"
						errorStyleClass="error" onkeypress="refuserToucheEntree(event);"
						style="width: 300px;" /> <logic:messagesPresent
			...
			<tr>
				<td><label for="supportContent"> <bean:message
							key="support.title.message" /> :
				</label></td>
				<td><html:textarea property="supportContent"
			...
			<tr>
				<td></td>
				<td><html:submit styleClass="support-cancel"
						...
						<bean:message key="support.button.cancel" />
					</html:submit> <html:submit onclick="return validate()" styleClass="support-send"
						style="background:#52A9BA; border:0; color:#fff; cursor:pointer; font-size:16px; font-weight:bold; height:26px; margin:4px 0 0 4px; text-align:center; vertical-align:middle; -webkit-border-radius:8px; -moz-border-radius:8px; border-radius:8px;float:right">
						<bean:message key="support.button.send" />
					</html:submit></td>
			</tr>
		</table>
	</html:form>
