	...
	<tr>
		<td>
			<div class="errorMessage">
				<html:errors />
			</div> <html:form action="CreateConsultation" method="POST">
				<table>
					<tr>
				...
				<input type="button" value=" - " onclick="removeChoice()" />
				<input type="button" value=" + " onclick="addChoice()" />
				<br />

				<table>
					<tr>
						<td colspan="2"><bean:message
								key="consultation.typeConsultation" /></td>
					</tr>
					<tr>
				...
				<html:submit styleClass="button" onclick="Valider();">
					<bean:message key="consultation.create" />
				</html:submit>
