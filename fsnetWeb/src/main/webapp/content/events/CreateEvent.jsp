...
<fieldset class="fieldsetAppli">
	...
	<table class="inLineTableDashBoardFieldset fieldsetTable">
		<tr>
			<td><html:form action="/CreateEvent">
					<table id="CreateEvent">
						...
						<tr>
							...
							<td><html:text property="eventAddress"
									styleId="eventAddress" errorStyleClass="error" /> <logic:messagesPresent
						...
						<tr>
							...
							<td><html:text property="eventEndDate"
									styleId="eventEndDate" errorStyleClass="error" /> <logic:messagesPresent
