...
public class SocialEntity extends SocialElement implements Serializable,
	...
	/**
	 * @param rolesInInteractions
	 *            the roles associated with the interactions to set
	 */
	...
	public boolean equals(Object obj) {
		...
		if (this.inscritpionDate != other.inscritpionDate
				&& (this.inscritpionDate == null || !this.inscritpionDate
						.equals(other.inscritpionDate))) {
			return false;
		}
		...
		if (this.lastConnection != other.lastConnection
				&& (this.lastConnection == null || !this.lastConnection
						.equals(other.lastConnection))) {
			return false;
		}
		if ((this.sex == null) ? (other.sex != null) : !this.sex
				.equals(other.sex)) {
			return false;
		}
		...
		if ((this.email == null) ? (other.email != null) : !this.email
				.equals(other.email)) {
			return false;
		}
	...
	public int hashCode() {
		...
		hash = 97
				* hash
				+ (this.lastConnection != null ? this.lastConnection.hashCode()
						: 0);
		hash = 97 * hash + (this.sex != null ? this.sex.hashCode() : 0);
		hash = 97 * hash
				+ (this.password != null ? this.password.hashCode() : 0);
		hash = 97 * hash
				+ (this.profession != null ? this.profession.hashCode() : 0);
	...
	/**
	 * @param favoriteInteractions
	 *            the favoriteInteractions to set
	 */
	...
	/**
	 * 
	 * @return the list of Profile visite where it's this social entity frofile
	 *         whitch visit
	 */
	...
	/**
	 * set the list of Profile visite where it's this social entity profile
	 * whitch visit
	 * 
	 * @param haveBeenVisit
	 */
