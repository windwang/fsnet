...
public void postMail(String liste[], String sujet, String message,String file) throws MessagingException {
...
public void envoyerMessage(String liste[], String sujet, String message) throws MessagingException {
...
/**
* une fonction qui permet l'authentifcation au près du serveur mail
*/
