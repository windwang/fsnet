...
@XmlRootElement(name = "getNumberOfNewAnnonceResponse", namespace = "http://webservice.fsnet.ili.univartois.fr/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getNumberOfNewAnnonceResponse", namespace = "http://webservice.fsnet.ili.univartois.fr/")
public class GetNumberOfNewAnnonceResponse {
