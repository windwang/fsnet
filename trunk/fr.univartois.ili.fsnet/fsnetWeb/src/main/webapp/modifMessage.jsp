        ...
        <div class="wrap background">
            ...
            <div id="community_menu"
                ...
                <table style="padding: 4px; border: 0;">
                    ...
                    <tr>
                        <td>
                            <a href="http://www.developpez.net/forums/group.php">
                                Groupes sociaux
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <a href="http://www.developpez.net/forums/album.php">
                                Images &amp; albums
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="vbmenu_option" title="nohilite">
                            <form id="pagenav_form" method="get" action="">
                                <p>
                                    <input class="bginput" id="pagenav_itxt"
                                           style="FONT-SIZE: 11px; size: 4;" />
                                </p>
                                <p>
                                    <input class="button" id="pagenav_ibtn" type="button"
                                           value="Go" />
                                </p>
                            </form>
                        </td>
        ...
        <div id="posts">
            <div style="align: center">
                <div class="page" style="WIDTH: 100%; TEXT-aLIGN: left">
                    <div style="PaDDING-RIGHT: 25px; PaDDING-LEFT: 25px; PaDDING-BOTTOM: 0px; PaDDING-TOP: 0px; text-align: left;">
                        <div id="edit3994424" style="PaDDING-RIGHT: 0px; PaDDING-LEFT: 0px; PaDDING-BOTTOM: 6px; PaDDING-TOP: 0px">
                            ...
                            <table class="tborder" id="post3994424" width="100%">
                                ...
                                <fsnet:message var="messageDTO" topic="${monTopic}">
                                    <tr valign="top">
                                        <td class="alt2" style="BORDER-BOTTOM: #d1d1e1 1px solid; width:20%">
