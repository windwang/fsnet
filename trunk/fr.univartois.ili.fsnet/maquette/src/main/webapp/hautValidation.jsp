...
<html>
    ...
    <body>
        <div id="menu">
            <dl>
                <dt>
                    <a class="${param.accueil}" href="index.jsp?accueil=current" title="Retour à l'accueil">Accueil</a>
                </dt>
            </dl>
            <dl>
                <dt>
                    <a class="${param.profil}" href="profil.jsp?profil=current" >Profil</a>
                </dt>
            </dl>
            <dl>
        ...
        <div id="logo">
            <h2 > 
                <span style ="color:red;">votre information est publi&#233e</span>
            </h2>
            <h1>
        ...
        <div id="feature"><img src="images/feature_img.gif" alt="Featured" />
            <div id="ssmenu1" >
                <h3>
                    <a href="AddAnnonce?idChoisi=0">Dernières annonces</a>
                </h3>
