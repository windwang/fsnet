                ...
                <form name='testform' method="post" action="AddEvenement" id="evenement"
                    ...
                    <table style="width: 633px">
                            ...
                            <td style="width: 228px">
                                <div style="align: right" class="Style1">
                                    <label style="text-align: left">
                                        <input name="titreEvenement" type="text" size="50" value="${titre}" />
                                    </label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 228px">
                                <textarea name="contenuEvenement" cols="57" rows="10">${contenu}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <th style="width: 193px" scope="row">Rendez-vous le</th>
                            <td>
                                <input type='text' name="dateDebut" value="${date}"
                                       size="8" />
