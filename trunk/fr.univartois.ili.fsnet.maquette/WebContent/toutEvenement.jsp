...
<table width="433">
	...
	<table>
		<tr>
			<th width ="150"><a href="AddEvenement?id=${maManif.id}">${maManif.nom}  </a></th><th>rendez-vous le</th>
			<th width ="20">${maManif.dateManif}</th>
            <th> 
		        <c:if test="${maManif.createur.id == entite.id}">
		              <a href="SuppEven?idEven=${maManif.id}&idEntite=${entite.id}"><img src="images/croix.jpg" width="15"></a>
    				  <a href="ModifEven1?idEven=${maManif.id}"><img src="images/crayon.jpeg" width="12"/></a>
			  </c:if>
           </th>
		</tr>
		</table>
