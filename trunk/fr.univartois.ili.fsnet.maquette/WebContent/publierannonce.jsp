...
<table style="width: 433">
	...
	<tr>
		...
		<td><textarea name="contenuAnnonce" cols="40" rows="10">${contenu}</textarea></td>
	</tr>
	<tr>
...
<input onclick="ds_sh(this);" name="dateFinAnnonce" readonly="readonly" style="cursor: text"  value="${datefin }"/><br />
