...
public class InteractionFacade {
	 ...
	 * 
	 * @param interaction
	 *            the interaction to add the interest in
	 * @param interest
	 *            the interest to add to the interaction
	 */
	 ...
	 *            the interaction to add the interest in
	 * @param interests
	 *            the list of interests to add to the interaction
	 */
	public final void addInterests(Interaction interaction,
	 ...
	 * 
	 * @param interaction
	 *            the interaction to remove the interest from
	 * @param interests
	 *            the interest to remove from the interaction
	 */
	public final void removeInterest(SocialEntity member,
			Interaction interaction, Interest interest) {
		if (interaction == null || interest == null) {
			throw new IllegalArgumentException();
		}
	 ...
	 * 
	 * @param entity
	 *            the entity who call the delete
	 * @param interaction
	 *            the interaction who is deleted
	 */
	public final void deleteInteraction(SocialEntity entity,
	 ...
	 * @param user
	 *            the user connected
	 * @return an HashMap with interaction as Key and his value contains his
	 *         class and the associated action-parameter in an array
	 * 
	...
	public final List<Interaction> getUnreadInteractionsForSocialEntityWithoutFilter(
			SocialEntity se) {
		if (se == null) {
			throw new IllegalArgumentException();
		}
	...
	public final List<Interaction> getUnreadInteractionsForSocialEntity(
			SocialEntity se) {

		return filterGroup.filterInteraction(se,
				getUnreadInteractionsForSocialEntityWithoutFilter(se));
	}

	public final List<Integer> getUnreadInteractionsIdForSocialEntity(
			SocialEntity se) {
		if (se == null) {
			throw new IllegalArgumentException();
		}
		...
		for (Interaction interaction : interactionsList) {
			List<InteractionGroups> interGroup = interaction
