...
<div class="wrap background"><tiles:useAttribute
	name="currentMenu" scope="request" ignore="true" /> <tiles:insert
	attribute="menu" />

<div style="float: left; width: 25%">
<div id="logo"><tiles:insert attribute="logo" /></div>
<div id="left" style="margin-top: 30px; width: 100%">
<h2><a><bean:message key="${pageTitle}" /></a></h2>
<tiles:insert attribute="left" /> <tiles:insert attribute="loggedUsers" />
</div>
