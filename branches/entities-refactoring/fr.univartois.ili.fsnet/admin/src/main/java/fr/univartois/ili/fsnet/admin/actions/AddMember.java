...
public class AddMember extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String name = dynaform.getString("nom");
        String firstName = dynaform.getString("prenom");
        String mail = dynaform.getString("email");

        SocialEntity entite = new SocialEntity(name, firstName, mail);
        String generatedPassword = Security.generateRandomPassword();
        entite.setPassword(Security.getEncodedPassword(generatedPassword));
     ...
     */
    private void sendConfirmationMail(SocialEntity entite, String password) {
        FSNetConfiguration conf = FSNetConfiguration.getInstance();
        Properties properties = FSNetConfiguration.getInstance().getFSNetConfiguration();
        String fsnetAddress = conf.getFSNetWebAddress();
        String message = createMessageRegistration(entite.getName(), entite.getFirstName(), fsnetAddress, password);
        // send a mail
