    ...
    <body onload="showMenu();init();">
        <div class="wrap background"><jsp:include page="haut.jsp"></jsp:include>
            ...
            <div id="left">
                ...
                <p>&nbsp;</p>
                <form name='testform' method="post" action="AddAnnonce" id="annonce" style='margin: 0px;'>
                    ...
                    <table style="width: 633px">
                            ...
                            <td style="width: 228px">
                                <div style="align: right" class="Style1">
                                    <label style="text-align: left">
                                        <input name="titreAnnonce" type="text" size="50" value="${titre}" />
                                    </label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 228px">
                                <textarea name="contenuAnnonce" cols="57" rows="10">${contenu}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <th style="width: 193px" scope="row">Date de fin</th>
                            <td>
                                <input type='text' name="dateFinAnnonce" value="${datefin}"  size="8" />
