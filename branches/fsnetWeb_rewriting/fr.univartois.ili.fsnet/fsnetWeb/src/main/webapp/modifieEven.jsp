    ...
    <body onload="showMenu();init();">
        <div class="wrap background"><jsp:include page="haut.jsp"></jsp:include>
            ...
            <div id="left">
                ...
                <p>&nbsp;</p>
                <form name='testform'  action="ModifEven2" id="evenement" style='margin: 0px;'>
                    <table style="width: 633px">
                            ...
                            <td style="width: 228px">
                                <div style="align: right" class="Style1">
                                    <label style="text-align: left">
                                        <input name="titreEvenement" type="text" size="50" value="${manif.nom}" />
                                    </label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 228px">
                                <textarea name="contenuEvenement" cols="57" rows="10">${manif.contenu}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <th style="width: 193px" scope="row">Rendez-vous le</th>
                            <td>
                                <input type='text' name="dateDebut" value="${manif.dateManif}" size="8" />
                                <button type='button' name='show1' onclick='CL.show();'>
                                    <img src="images/button_calendar.gif" height="20" width="20" />
                                </button>
                            </td>
                        </tr>
                        <tr>
